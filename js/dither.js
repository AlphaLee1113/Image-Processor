(function(imageproc) {
    ...
    imageproc.dither = function(inputData, outputData, matrixType) {
        ...
        // matrix types
        // console.log("Math.sqrt(levels-1) is", Math.sqrt(levels-1))
        for (var y = 0; y < inputData.height; y++) {
            for (var x = 0; x < inputData.width; x++) {
                ...
                value = value / 255 * levels;// get the grayscale value in 0-levels

                // Get the corresponding threshold of the pixel
                // var threshold = matrix[y % 2][x % 2]; //Math.sqrt(levels-1)
